...
// Credenciales de firma release del ADMIN (NUNCA versionadas). Si el archivo
...
android {
    namespace = "com.roberto.gestorpro"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.roberto.gestorpro"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
// Exporta el esquema de Room para poder validar migraciones en tests.
ksp {
