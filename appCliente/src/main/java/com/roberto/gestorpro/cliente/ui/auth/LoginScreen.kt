...
fun LoginScreen(
    ...
    Column(
         ...
         * Es el wordmark oficial de Trazys (aplicación). El login representa
         * la app, no el centro: no se muestra logo ni nombre del gimnasio.
         */
        Image(
            painter = painterResource(R.drawable.trazys_logo),
            contentDescription = textoNombreApp,
